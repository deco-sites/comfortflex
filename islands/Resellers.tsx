    ...
    if (resellers.length > 0) {
        return (
            <div class="container pt-12 pb-8 flex flex-col items-center">
                <h1 class="text-base uppercase text-black font-semibold text-center">Representantes</h1>
                ...
                <div class="mt-3 mb-8 border border-black">
                    <select class="w-min cursor-pointer outline-none uppercase p-3 sm:py-2 sm:px-5 mr-3 sm:mr-4 text-black rounded-none text-xs sm:text-sm" onChange={stateChange}>
                        ...
                        filterResellers.map((reseller) => {
                            return (
                                <div class="block border border-[#d1d1d1] p-5">
                                    <div class="uppercase text-base text-black font-semibold">{reseller.name}</div>
                                    <small class="block text-xs mb-3 text-[#919191] uppercase">{reseller.states}</small>

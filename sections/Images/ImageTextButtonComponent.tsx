    ...
    return (
        <div className="container min-[430px]:bg-black lg:bg-transparent min-[430px]:flex lg:block min-[430px]:items-stretch min-[430px]:px-[15px] min-[430px]:py-7 lg:px-[30px] lg:py-0 relative mb-10">
            <img
                ...
                width={834}
                height={666}
                className="hidden object-cover object-center min-[430px]:block w-1/2 lg:w-full lg:max-w-[80%] h-auto"
            />
            <img
                src={isMobile}
                alt={alt}
                width={834}
                height={666}
                className="block min-[430px]:hidden w-full h-auto"
            />
            <div className="flex flex-col items-start w-[90%] m-auto relative -mt-[150px] min-[430px]:mt-0 p-[38px] min-[430px]:p-7 lg:absolute lg:translate-y-[-50%] lg:top-1/2 lg:right-0 min-[430px]:w-1/2 lg:w-2/4 lg:px-[68px] lg:py-[63px] bg-black lg:mr-[30px] lg:mt-0">
                ...
                <a href={link} className="flex items-center gap-x-2 text-sm min-[430px]:text-base text-white py-3 px-8 border border-solid border-white mt-7 lg:mt-[35px]" style={{ lineHeight: "1.2" }}>
                    {buttonText}

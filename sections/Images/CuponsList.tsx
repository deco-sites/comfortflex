...
const Banner = ({ icon, valor, cupom, obs1, obs2 }: CupomList) => {
  return (
    <div className="cupomList__item relative flex-none md:flex-initial w-[360px] sm:w-[50vw] md:w-[60vw] lg:w-auto lg:mb-10">
      <div class="flex items-center bg-white w-full rounded">
        ...
        <div class="cupomList__right block bg-white border-l border-dashed pl-2">
          <div class="flex items-center gap-2 px-2">
            ...
            <span
              class="font-semibold  text-sm py-1 px-5 border border-dashed "
              style="border: 1px dashed #7852A3"
            >
              {cupom}
            </span>
          </div>
          <button class="cupomList__btn mt-2 mb-1 h-8 text-white text-xs font-semibold flex justify-center items-center hidden">
            Copiar Código
          </button>
...
const CupomList = ({
  ...
  return (
    <div class="bg-brand w-full cupomList">
      <div class="cupomList__title text-center text-base sm:text-xl text-white uppercase">
        Cupons Black Friday
      </div>

        ...
        <div class="flex-none w-header-laterals flex items-center justify-end gap-x-5">
          ...
          >
            ...
            <svg id="_01_align_center" data-name="01 align center" xmlns="http://www.w3.org/2000/svg" width="13.989" height="18.652" viewBox="0 0 13.989 18.652">
              <path id="Caminho_10" data-name="Caminho 10" d="M16.989,21.772H15.434V17.852a2.3,2.3,0,0,0-2.3-2.3H6.852a2.3,2.3,0,0,0-2.3,2.3v3.919H3V17.852A3.857,3.857,0,0,1,6.852,14h6.284a3.857,3.857,0,0,1,3.852,3.852Z" transform="translate(-3 -3.12)" fill="#bc81ff" />

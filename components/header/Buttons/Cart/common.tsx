...
function CartButton({ loading, currency, total, items }: Props) {
  ...
  return (
    <div class="indicator">
      <span
        class={`flex items-center justify-center absolute top-0 right-0 w-4 h-4 bg-white lg:bg-brand  text-black lg:text-white rounded-full text-xs ${totalItems === 0 ? "hidden" : ""
          }`}
      >
      ...
      <Button
        class="btn-circle btn-sm btn-ghost fill-white hover:bg-transparent lg:fill-brand"
      ...
      >
        ...
        <svg id="_01_align_center" data-name="01 align center" xmlns="http://www.w3.org/2000/svg" width="18.652" height="18.652" viewBox="0 0 18.652 18.652">

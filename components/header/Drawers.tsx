...
const HeaderLogin = (props: any) => {
  ...
  return (
    <div class="flex justify-between items-center bg-brand p-4">
      <a
...
const SearchHeader = (props: any) => {
  ...
  return (
    <div class="flex justify-between items-center bg-brand px-4">
...
const MinicartHeader = (props: any) => {
  ...
  return (
    <div class="flex justify-between items-center p-4">
      <div style="color:#bc81ff" class="flex items-center text-lg text-brand uppercase font-medium">
        Sacola
      </div>
      {onClose && (

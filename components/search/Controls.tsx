...
export type Props =
  & Pick<ProductListingPage, "filters" | "breadcrumb" | "sortOptions" | "productsFound" | "Pagination" | "pageInfo">
  & {
...
function SearchControls(
  ...
  return (
        ...
        <>
          <div class="bg-base-100 flex flex-col h-full sm:divide-y overflow-y-hidden">
            <div class="flex justify-between items-center">
              <h1 class="px-4 py-3">
                <span class="hidden sm:block font-medium text-2xl">Filtrar</span>
                <span class="block sm:hidden font-light text-2xl uppercase">Filtros</span>
              </h1>
              <Button class="btn btn-ghost hover:bg-transparent" onClick={() => open.value = false}>
    ...
    >
      ...
      <div class="border-b border-[#D1D1D1] mb-4 sm:mb-7 w-full bg-white fixed z-30 sm:pt-5" style="top:90px">
          ...
          <div class="flex flex-col justify-between sm:gap-4 sm:flex-row sm:items-end sm:h-auto">
            ...
            <div class="flex items-center gap-x-5 mb-7">
              ...
              <div class="flex flex-row items-center justify-between sm:gap-4 sm:border-none w-full ">
                ...
                {
                  records > 0 ? (
                    <div class="block sm:hidden font-medium text-xs text-black">{records === 1 ? `1 Produto` : `${records} Produtos`}</div>
                  ) : null
                }

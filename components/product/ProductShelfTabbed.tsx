...
function TabbedProductShelf(
  { tabs, title, description, layout, cardLayout, tabIndex, id: sectionId }:
    Props,
) {
  const id = useId();
  ...
  return (
    <div class="w-full container py-8 flex flex-col gap-5 lg:gap-7 lg:py-10">
      <div class="text-center text-base sm:text-xl text-brand font-bold uppercase">
        {title || ""}
      </div>
      <div class="flex justify-center">
        <div
          style="border:solid 1px #BC81FF; border-radius:23px;"

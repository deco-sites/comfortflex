  ...
  return (
    <div className="relative">
      <div class="w-full lg:bg-brand flex flex-col gap-8 lg:gap-16 mt-7 pt-0 lg:pb-0 lg:mb-28">
        <div className="md:pt-16 text-center text-base sm:text-xl text-brand lg:text-white">
          {title || ""}
        </div>
      ...
      <a
        style="border-radius:23px; color: #BC81FF; border: 1px solid #bc81ff"
        href={link}
        className="block w-fit py-3 lg:py-2 px-7 lg:bg-white text-white text-sm mt-4 mx-auto lg:m-0 uppercase lg:border lg:border-brand lg:absolute lg:left-[73%] lg:-bottom-[50px] lg:-translate-x-[50%]"
      >
        {buttonText}
      </a>
    </div>

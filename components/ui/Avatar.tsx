...
const variants = {
  ...
  "disabled-active":
    `border border-brand bg-brand text-white rounded-full relative after:absolute after:left-0 after:top-1/2 after:h-[1px] after:bg-white after:w-full after:block after:-rotate-45 after:content-[""]`,

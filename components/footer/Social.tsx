...
<svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25">
  <g id="_05.instagram" data-name="05.instagram">
    <circle id="Elipse_180" data-name="Elipse 180" cx="1.998" cy="1.998" r="1.998" transform="translate(10.502 10.502)" fill="#bc81ff"/>
    <path id="Caminho_53" data-name="Caminho 53" d="M53.246,45.65H48.135a2.5,2.5,0,0,0-2.5,2.5v5.109a2.5,2.5,0,0,0,2.5,2.5h5.111a2.5,2.5,0,0,0,2.5-2.5V48.144A2.5,2.5,0,0,0,53.246,45.65Zm-2.555,8.32A3.271,3.271,0,1,1,53.96,50.7a3.271,3.271,0,0,1-3.269,3.27Zm3.289-5.733a.809.809,0,1,1,.807-.807A.809.809,0,0,1,53.98,48.237Z" transform="translate(-38.191 -38.199)" fill="#bc81ff"/>
    <path id="Caminho_54" data-name="Caminho 54" d="M12.5,0A12.5,12.5,0,1,0,25,12.5,12.5,12.5,0,0,0,12.5,0Zm6.25,15.026a3.727,3.727,0,0,1-3.724,3.724H9.974A3.729,3.729,0,0,1,6.25,15.026V9.974A3.729,3.729,0,0,1,9.974,6.25h5.053A3.729,3.729,0,0,1,18.75,9.974Z" fill="#bc81ff"/>
  </g>
</svg>
...
<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25">
  <path id="tiktok_1_" data-name="tiktok (1)" d="M12.5,0A12.5,12.5,0,1,0,25,12.5,12.5,12.5,0,0,0,12.5,0Zm6.271,9.564v1.693a5.906,5.906,0,0,1-3.614-1.228l.012,5.21a4.364,4.364,0,0,1-1.309,3.106,4.455,4.455,0,0,1-2.489,1.245,4.588,4.588,0,0,1-.672.049,4.47,4.47,0,0,1-2.74-.926,4.545,4.545,0,0,1-.421-.368,4.38,4.38,0,0,1-.2-6.04A4.469,4.469,0,0,1,10.7,10.8a4.587,4.587,0,0,1,.672.05v2.367a2.107,2.107,0,1,0,1.449,2l0-3.489V5.362h2.331a3.608,3.608,0,0,0,3.61,3.574h.007v.628Z" fill="#bc81ff"/>
</svg>
...
<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25">
  <g id="Grupo_119" data-name="Grupo 119" transform="translate(-0.228 0.404)">
    <circle id="Elipse_182" data-name="Elipse 182" cx="12.5" cy="12.5" r="12.5" transform="translate(0.228 -0.404)" fill="#bc81ff"/>

                    ...
                    <div class="flex flex-col items-center md:max-w-6xl md:flex-row md:gap-6 md:justify-between">
                        ...
                        <div class="flex flex-col items-center gap-3 mt-5 max-w-sm md:items-end md:flex-row md:mt-0">
                            <div class="flex items-center gap-3 text-xs text-gray-600">
                                <p>Created by</p>
                                <a
                                    href="https://www.wavecommerce.com.br/?utm_source=rodape&utm_medium=site+comfortflex"
                                    target="_blank"
                                >
                                    <svg
                                        ...
                                        width="112.648"
                                        height="20.187"
                                        viewBox="0 0 112.648 20.187"
                                    >
                                        <g
                                            id="Grupo_55"
                                            data-name="Grupo 55"
                                            transform="translate(-1205.982 -5426.007)"
                                        >
                                            <path
                                                id="Vector"
                                                d="M3.822,7.041A2.327,2.327,0,0,0,6,5.666V2.875A2.368,2.368,0,0,0,3.822,1.459,2.684,2.684,0,0,0,1.358,4.25,2.643,2.643,0,0,0,3.822,7.041ZM5.976.719A.576.576,0,0,1,6.519.148h.252A.582.582,0,0,1,7.315.74V7.7a.568.568,0,0,1-.543.592H6.519A.556.556,0,0,1,6,7.8a3.648,3.648,0,0,1-2.173.7A4.051,4.051,0,0,1,0,4.25,4.048,4.048,0,0,1,3.8,0,3.569,3.569,0,0,1,5.976.719Z"
                                                transform="translate(1249.871 5427.069)"
                                                fill="#0066e4"
                                            />
                                            <path
                                                id="Vector-2"
                                                data-name="Vector"
                                                d="M3.822,7.041A2.327,2.327,0,0,0,6,5.666V2.875A2.368,2.368,0,0,0,3.822,1.459,2.684,2.684,0,0,0,1.358,4.25,2.643,2.643,0,0,0,3.822,7.041ZM5.976.719A.576.576,0,0,1,6.519.148h.252A.569.569,0,0,1,7.315.74V7.7a.582.582,0,0,1-.543.592H6.519A.556.556,0,0,1,6,7.8a3.648,3.648,0,0,1-2.173.7A4.051,4.051,0,0,1,0,4.25,4.048,4.048,0,0,1,3.8,0,3.569,3.569,0,0,1,5.976.719Z"
                                                transform="translate(1249.871 5427.069)"
                                                fill="#0066e4"
                                            />
                                            <path
                                            ...
                                            <path
                                                id="Vector-5"
                                                data-name="Vector"
                                                d="M3.23,6.463a8.862,8.862,0,0,1-1.685-.152l.8,2.406a1.205,1.205,0,0,0,1.124.845h.582A1.2,1.2,0,0,0,5.2,8.63l.7-2.6a8.333,8.333,0,0,1-2.668.434Zm9.209-3.273L12.078,1.91a7.266,7.266,0,0,0-1.184.694,15.222,15.222,0,0,0-1.224,1c-.04.043-.08.065-.12.108L10.874,8.63a1.2,1.2,0,0,0,1.144.932H12.6A1.2,1.2,0,0,0,13.723,8.7l2.488-7.63a2.491,2.491,0,0,0-.4-.022,8.771,8.771,0,0,0-2.849.477ZM15.81,0c.241,0,.5,0,.742.022a7.88,7.88,0,0,1,1,.108l-.341,1.019-2.568,7.89A2.183,2.183,0,0,1,12.6,10.6h-.582A2.2,2.2,0,0,1,9.931,8.912L8.708,4.4A10.26,10.26,0,0,1,7.062,5.509L6.139,8.934a2.2,2.2,0,0,1-2.087,1.691H3.471A2.183,2.183,0,0,1,1.425,9.064l-1-3.035L0,4.772a12.022,12.022,0,0,0,1.164.369A8.559,8.559,0,0,0,3.23,5.4a7.053,7.053,0,0,0,3.01-.65c.04-.022.1-.043.14-.065a9.216,9.216,0,0,0,1.083-.65c.321-.238.642-.477.943-.715.221-.2.421-.369.642-.542.06-.065.14-.108.2-.173a10.593,10.593,0,0,1,1.1-.889A9.838,9.838,0,0,1,11.8.87,8.687,8.687,0,0,1,13.382.306,8.3,8.3,0,0,1,15.81,0Z"
                                                transform="translate(1210.371 5435.568)"
                                                fill="#0066e4"
                                            />
                                            <path
                                                id="Vector-6"
                                                data-name="Vector"
                                                d="M3.23,6.463a8.862,8.862,0,0,1-1.685-.152l.8,2.406a1.225,1.225,0,0,0,1.124.845h.582A1.2,1.2,0,0,0,5.2,8.63l.7-2.6a8.333,8.333,0,0,1-2.668.434Zm9.209-3.273L12.078,1.91a7.266,7.266,0,0,0-1.184.694,15.222,15.222,0,0,0-1.224,1c-.04.043-.08.065-.12.108L10.874,8.63a1.2,1.2,0,0,0,1.144.932H12.6A1.2,1.2,0,0,0,13.723,8.7l2.488-7.63a2.491,2.491,0,0,0-.4-.022,8.771,8.771,0,0,0-2.849.477ZM15.81,0c.241,0,.5,0,.742.022a7.88,7.88,0,0,1,1,.108l-.341,1.019-2.568,7.89A2.183,2.183,0,0,1,12.6,10.6h-.582A2.2,2.2,0,0,1,9.931,8.912L8.708,4.4A10.26,10.26,0,0,1,7.062,5.509L6.139,8.934a2.2,2.2,0,0,1-2.087,1.691H3.471A2.183,2.183,0,0,1,1.425,9.064l-1-3.035L0,4.772a12.022,12.022,0,0,0,1.164.369A8.559,8.559,0,0,0,3.23,5.4a7.053,7.053,0,0,0,3.01-.65c.04-.022.1-.043.14-.065a9.216,9.216,0,0,0,1.083-.65c.321-.238.642-.477.943-.715.221-.2.421-.369.642-.542.06-.065.14-.108.2-.173a10.593,10.593,0,0,1,1.1-.889A9.838,9.838,0,0,1,11.8.87,8.687,8.687,0,0,1,13.382.306,8.3,8.3,0,0,1,15.81,0Z"
                                                transform="translate(1210.371 5435.568)"
                                                fill="#0066e4"
                                            />
                                            <path
                                                id="Vector-7"
                                                data-name="Vector"
                                                d="M10.793.011a.539.539,0,0,1,.183.021L11.25.1a.6.6,0,0,1,.389.3.56.56,0,0,1,.023.468L8.917,8.1a.608.608,0,0,1-.595.4H8a.614.614,0,0,1-.618-.426L5.852,3.2,4.342,8.074a.656.656,0,0,1-.618.426H3.4a.637.637,0,0,1-.595-.4L.041.862A.56.56,0,0,1,.064.394.657.657,0,0,1,.453.1L.728.032a.626.626,0,0,1,.778.362L3.473,5.542,5.074.479A.656.656,0,0,1,5.692.053h.275a.634.634,0,0,1,.618.426L8.208,5.542,10.175.394a.651.651,0,0,1,.618-.383Z"
                                                transform="translate(1238.167 5427.069)"
                                                fill="#0066e4"
                                            />
                                            <path
                                                id="Vector-8"
                                                data-name="Vector"
                                                d="M10.793.011a.539.539,0,0,1,.183.021L11.25.1a.6.6,0,0,1,.389.3.56.56,0,0,1,.023.468L8.917,8.1a.608.608,0,0,1-.595.4H8a.614.614,0,0,1-.618-.426L5.852,3.2,4.342,8.074a.656.656,0,0,1-.618.426H3.4a.637.637,0,0,1-.595-.4L.041.862A.56.56,0,0,1,.064.394.657.657,0,0,1,.453.1L.728.032a.626.626,0,0,1,.778.362L3.473,5.542,5.074.479A.656.656,0,0,1,5.692.053h.275a.614.614,0,0,1,.618.426L8.208,5.542,10.175.394a.651.651,0,0,1,.618-.383Z"
                                                transform="translate(1238.167 5427.069)"
                                                fill="#0066e4"
                                            />
                                            <path
                                                id="Vector-9"
                                                data-name="Vector"
                                                d="M6.565,0a.609.609,0,0,1,.207.042L7,.149a.6.6,0,0,1,.282.34.668.668,0,0,1-.019.467L4.269,8.16A.5.5,0,0,1,3.8,8.5H3.535a.515.515,0,0,1-.471-.34L.053.977A.668.668,0,0,1,.034.51.538.538,0,0,1,.316.17L.542.064a.5.5,0,0,1,.678.3L3.667,6.2,6.095.361A.549.549,0,0,1,6.565,0Z"
                                                transform="translate(1258.649 5427.069)"
                                                fill="#0066e4"
                                            />
                                            <path
                                                id="Vector-10"
                                            ...
                                            <path
                                                id="Vector-11"
                                                data-name="Vector"
                                                d="M7.185,2.072a.611.611,0,0,1-.154.782l-.212.169a.51.51,0,0,1-.424.085.524.524,0,0,1-.347-.275,2.527,2.527,0,0,0-2.2-1.374A2.67,2.67,0,0,0,1.329,4.25,2.67,2.67,0,0,0,3.852,7.041,2.475,2.475,0,0,0,6.068,5.624a.51.51,0,0,1,.713-.233l.231.127a.606.606,0,0,1,.27.359.559.559,0,0,1-.039.465A3.847,3.847,0,0,1,3.872,8.5,4.074,4.074,0,0,1,0,4.25,4.059,4.059,0,0,1,3.852,0,3.808,3.808,0,0,1,7.185,2.072Z"
                                                transform="translate(1239.63 5437.694)"
                                                fill="#0066e4"
                                            />
                                            <path
                                                id="Vector-12"
                                                data-name="Vector"
                                                d="M7.185,2.072a.611.611,0,0,1-.154.782l-.212.169a.51.51,0,0,1-.424.085.524.524,0,0,1-.347-.275,2.527,2.527,0,0,0-2.2-1.374A2.67,2.67,0,0,0,1.329,4.25,2.67,2.67,0,0,0,3.852,7.041,2.475,2.475,0,0,0,6.068,5.624a.51.51,0,0,1,.713-.233l.231.127a.606.606,0,0,1,.27.359.559.559,0,0,1-.039.465A3.847,3.847,0,0,1,3.872,8.5,4.074,4.074,0,0,1,0,4.25,4.059,4.059,0,0,1,3.852,0,3.83,3.83,0,0,1,7.185,2.072Z"
                                                transform="translate(1239.63 5437.694)"
                                                fill="#0066e4"
                                            />
                                            <path
                                                id="Vector-13"
                                                data-name="Vector"
                                                d="M4.389,7.041A2.866,2.866,0,0,0,7.271,4.229,2.835,2.835,0,0,0,4.389,1.438a2.83,2.83,0,0,0-2.86,2.791A2.847,2.847,0,0,0,4.389,7.041ZM8.778,4.25A4.321,4.321,0,0,1,4.389,8.5,4.321,4.321,0,0,1,0,4.25,4.3,4.3,0,0,1,4.367,0,4.327,4.327,0,0,1,8.778,4.25Z"
                                                transform="translate(1246.945 5437.694)"
                                                fill="#0066e4"
                                            />
                                            <path
                                                id="Vector-14"
                                            ...
                                            <path
                                                id="Vector-19"
                                                data-name="Vector"
                                                d="M5.849,3.252a.681.681,0,0,1-.122.455.46.46,0,0,1-.366.2H5.135a.532.532,0,0,1-.487-.542c-.1-1.193-.7-1.865-1.688-1.865A1.857,1.857,0,0,0,1.2,3.036V7.892A.57.57,0,0,1,.714,8.5H.487A.557.557,0,0,1,0,7.892V.759A.57.57,0,0,1,.487.152H.714A.532.532,0,0,1,1.2.65,2.705,2.705,0,0,1,2.959,0C4.578,0,5.692,1.236,5.849,3.252Z"
                                                transform="translate(1295.222 5437.694)"
                                                fill="#0066e4"
                                            />
                                            <path
                                                id="Vector-20"
                                            ...
                                            <path
                                                id="Vector-21"
                                                data-name="Vector"
                                                d="M1.611,3.817H7.19A2.829,2.829,0,0,0,4.378,1.455,2.764,2.764,0,0,0,1.611,3.817Zm7.167.443a3.625,3.625,0,0,1-.023.485.641.641,0,0,1-.635.527H1.747a3.012,3.012,0,0,0,2.79,1.772h.34A3.142,3.142,0,0,0,6.714,6.18a.64.64,0,0,1,.476-.19.658.658,0,0,1,.476.211l.2.211a.569.569,0,0,1,.045.7c-.023.021-.045.063-.068.084A4.683,4.683,0,0,1,5.194,8.457a1.646,1.646,0,0,1-.272.021A4.132,4.132,0,0,1,4.4,8.5V8.479A4.408,4.408,0,0,1,0,4.239,4.29,4.29,0,0,1,4.378,0a4.328,4.328,0,0,1,4.4,4.26Z"
                                                transform="translate(1284.982 5437.694)"
                                                fill="#0066e4"
                                            />
                                            <path
                                                id="Vector-22"
                                                data-name="Vector"
                                                d="M1.611,3.817H7.19A2.829,2.829,0,0,0,4.378,1.455,2.764,2.764,0,0,0,1.611,3.817Zm7.167.443a3.625,3.625,0,0,1-.023.485.641.641,0,0,1-.635.527H1.747a3.012,3.012,0,0,0,2.79,1.772h.34A3.142,3.142,0,0,0,6.714,6.18a.64.64,0,0,1,.476-.19.752.752,0,0,1,.476.211l.2.211a.569.569,0,0,1,.045.7c-.023.021-.045.063-.068.084A4.683,4.683,0,0,1,5.194,8.457a1.646,1.646,0,0,1-.272.021A4.132,4.132,0,0,1,4.4,8.5V8.479A4.408,4.408,0,0,1,0,4.239,4.29,4.29,0,0,1,4.378,0a4.328,4.328,0,0,1,4.4,4.26Z"
                                                transform="translate(1284.982 5437.694)"
                                                fill="#0066e4"
                                            />
                                            <path
                                                id="Vector-23"
                                                data-name="Vector"
                                                d="M7.185,2.072a.611.611,0,0,1-.154.782l-.193.169a.51.51,0,0,1-.424.085.524.524,0,0,1-.347-.275,2.527,2.527,0,0,0-2.2-1.374A2.67,2.67,0,0,0,1.348,4.25,2.67,2.67,0,0,0,3.872,7.041,2.475,2.475,0,0,0,6.087,5.624.51.51,0,0,1,6.8,5.392l.212.127a.606.606,0,0,1,.27.359.559.559,0,0,1-.039.465A3.847,3.847,0,0,1,3.872,8.5,4.074,4.074,0,0,1,0,4.25,4.059,4.059,0,0,1,3.852,0,3.808,3.808,0,0,1,7.185,2.072Z"
                                                transform="translate(1302.537 5437.694)"
                                                fill="#0066e4"
                                            />
                                            <path
                                                id="Vector-24"
                                            ...
                                            <path
                                                id="Vector-25"
                                                data-name="Vector"
                                                d="M1.342,3.817h4.65A2.53,2.53,0,0,0,3.648,1.455,2.479,2.479,0,0,0,1.342,3.817Zm5.973.443a4.347,4.347,0,0,1-.019.485.572.572,0,0,1-.529.527H1.456A2.528,2.528,0,0,0,3.78,7.044h.284A2.462,2.462,0,0,0,5.595,6.18a.491.491,0,0,1,.4-.19.513.513,0,0,1,.4.211l.17.211a.66.66,0,0,1,.038.7c-.019.021-.038.063-.057.084A3.677,3.677,0,0,1,4.328,8.457a1.15,1.15,0,0,1-.227.021,2.874,2.874,0,0,1-.435.021V8.479A4.069,4.069,0,0,1,0,4.239,3.959,3.959,0,0,1,3.648,0,3.993,3.993,0,0,1,7.315,4.26Z"
                                                transform="translate(1311.315 5437.694)"
                                                fill="#0066e4"
                                            />
                                            <path
                                                id="Vector-26"
                                            ...
                                            <path
                                                id="Vector-27"
                                                data-name="Vector"
                                                d="M1.611,3.817H7.19A2.829,2.829,0,0,0,4.378,1.455,2.782,2.782,0,0,0,1.611,3.817Zm7.167.443a3.628,3.628,0,0,1-.023.485.641.641,0,0,1-.635.527H1.747a3.012,3.012,0,0,0,2.79,1.772h.34A3.142,3.142,0,0,0,6.714,6.18a.64.64,0,0,1,.476-.19.658.658,0,0,1,.476.211l.2.211a.569.569,0,0,1,.045.7c-.023.021-.045.063-.068.084A4.683,4.683,0,0,1,5.194,8.457a1.646,1.646,0,0,1-.272.021A4.132,4.132,0,0,1,4.4,8.5V8.479A4.408,4.408,0,0,1,0,4.239,4.29,4.29,0,0,1,4.378,0a4.328,4.328,0,0,1,4.4,4.26Z"
                                                transform="translate(1265.963 5427.069)"
                                                fill="#0066e4"
                                            />
                                            <path
                                                id="Vector-28"
